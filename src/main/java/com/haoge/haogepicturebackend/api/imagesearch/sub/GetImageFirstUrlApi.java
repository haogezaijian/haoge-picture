...
public class GetImageFirstUrlApi {  
    ...
    public static void main(String[] args) {  
        // 请求目标 URL  
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=5032746776362613442&sign=12663e97cd54acd88139901740215384&tpl_from=pc";
